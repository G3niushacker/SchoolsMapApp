...
import 'package:schoolsmapapp/Models/ExcelData.dart';
import 'package:schoolsmapapp/Screens/MapScreen.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: ListView(
          children: <Widget>[
            SizedBox(height: 10,),
            Image.asset("Assets/school.png",height: 50,width: 50,),
            SizedBox(height: 20,),
            Row(
              crossAxisAlignment: CrossAxisAlignment.end,
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                Text("Click on the province of \n                interest",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
              ],
            ),
            SizedBox(height: 10,),
            buttons("  All",context),
